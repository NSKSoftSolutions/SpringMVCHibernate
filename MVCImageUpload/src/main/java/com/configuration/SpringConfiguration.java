...
@Configuration
public class SpringConfiguration extends WebMvcConfigurerAdapter implements WebApplicationInitializer {
	...
	public SessionFactory addSessionFactory(DataSource dataSource) {
		...
		builder.addAnnotatedClasses(UploadFile.class);
	...
	@Bean
	public Repositry addrepo(SessionFactory sessionFactory) {
		SpringRepositry repo = new SpringRepositry(sessionFactory);
	...
	public InternalResourceViewResolver viewresolvere() {
		...
		return irv;  // 8099733888
	}

	public void onStartup(ServletContext servletContext) throws ServletException {
		// TODO Auto-generated method stub
		System.out.println("setting up the dev environement");
